			...
			if(selected === 10){
				...
				for(let i=1; i<=pageNumber; i++){
					if(pageNumber === 1){
						...
						for(let i=10*(pageNumber); i<100; i++){
							rows[i].style.display = 'none';
						}
						for(let i=0; i<10*(pageNumber-1); i++){
							rows[i].style.display = 'none';
						}
						for(let i=10*(pageNumber-1); i<10*pageNumber; i++){
							if(rows[i].style.display === 'none'){
				...
				for(let i=1; i<=pageNumber; i++){
					if(pageNumber === 1){
						for(let i=20*pageNumber; i<100; i++){
							rows[i].style.display = 'none';
						}
						for(let i=20*(pageNumber-1); i<20*pageNumber; i++){
							if(rows[i].style.display === 'none'){
								rows[i].style.display = 'table-row';
							}
						}
						...
						for(let i=0; i<20*(pageNumber-1); i++){
							rows[i].style.display = 'none';
						}
						for(let i=20*(pageNumber-1); i<20*pageNumber; i++){
							if(rows[i].style.display === 'none'){
				...
				for(let i=1; i<=pageNumber; i++){
					if(pageNumber === 1){
						for(let i=50*pageNumber; i<100; i++){
							rows[i].style.display = 'none';
						}
						for(let i=50*(pageNumber-1); i<50*pageNumber; i++){
							if(rows[i].style.display === 'none'){
								rows[i].style.display = 'table-row';
							}
						}
						...
						for(let i=0; i<50*(pageNumber-1); i++){
							rows[i].style.display = 'none';
						}
						for(let i=50*(pageNumber-1); i<50*pageNumber; i++){
							if(rows[i].style.display === 'none'){
				...
				let rows = document.querySelectorAll('.details');
				if(pageNumber === 1){
					for(let i=100*(pageNumber-1); i<100*pageNumber; i++){
						if(rows[i].style.display === 'none'){
							rows[i].style.display = 'table-row';
						}
					}
